#!/usr/bin/env python3
"""
Command-line script for generating exercise illustrations.
...
Usage:
    ...
    python scripts/generate_images.py --exercise chin_tuck --steps 40 --seed 123
...
from src.image_generation.config import ImageGenerationConfig, PRESETS
from src.image_generation.service import ImageGenerationService, generate_all_seed_exercises
from src.image_generation.prompts import get_all_exercise_ids, get_prompts_for_exercise
...
def generate_all(config: ImageGenerationConfig, dry_run: bool = False):
